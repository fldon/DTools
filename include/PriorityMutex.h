...
{
    //TODO: create shared priority mutex for reader/writer situations. But how would that work? Same as normal priority mutex but with separate functions for lock_shared?
};
